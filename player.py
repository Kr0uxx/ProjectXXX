...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        self.idle_images = []
        for i in range(6):
            self.idle_images.append(pygame.image.load(f'graphics\\Characters\\Hero\\idle\\ChikIdle_frame{i}.png'))
        self.rect = pygame.image.load('graphics\\Characters\\Hero\\idle\\ChikIdle_frame0.png').get_rect(topleft=pos)
        self.rect[2] = 50
        self.rect[3] = 100
        self.run_images = []
        for i in range(10):
            self.run_images.append(pygame.image.load(f'graphics\\Characters\\Hero\\run\\ChikRun_frame{i}.png'))
        self.direction = 1
